...
def generate_response(user_query: str, search_results: list, temperature: float = 0.3, max_tokens: int = 512) -> Tuple[str, float, int]:
    """
    Constructs the prompt and sends it to OpenAI for generation.
    Supports dynamic UI parameters for temperature and max_tokens.
    ...
    try:
        ...
        # Specifically catch OpenAI API limits/timeouts
        ...
        # Graceful degradation for the UI (hides raw backend errors from the user)
